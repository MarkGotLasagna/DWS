...
% Correlation is studied using Spearman correlation coefficient
function [] = spearman_plot_peaks(filename, region, row_sigma, column_sigma)
    ...
    correlations = coeff_correlation(V_norm_smooth, "Spearman", interval);
